...
var current_character : CharacterSheetData = null
...
func get_current_character()->CharacterSheetData:
...
func new_character(file_name:String):
	save_character()
	current_character = CharacterSheetData.new()
	current_character_file_name = file_name
